DROP TABLE IF EXISTS judge_token CASCADE;
DROP TABLE IF EXISTS map_user_power CASCADE;
DROP TABLE IF EXISTS map_group_user CASCADE;
DROP TABLE IF EXISTS map_group_user_power CASCADE;
DROP TABLE IF EXISTS map_problem_execute CASCADE;
DROP TABLE IF EXISTS map_contest_problem CASCADE;
DROP TABLE IF EXISTS map_contest_user CASCADE;
...
DROP TABLE IF EXISTS map_problem_tag CASCADE;
...
DROP TABLE IF EXISTS map_inpublic_group_user CASCADE;
